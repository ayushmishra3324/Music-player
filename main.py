...
class Player(tk.Frame):
	...
	def play_song(self, event=None):
		...
		# wallpaper_folder = 'new'
		# new_image = change_wallpaper(wallpaper_folder)
		# self.currentimage = new_image
		# self.bg_image = PhotoImage(file=self.currentimage)
...
def change_wallpaper(wallpaper_folder):
	...
	return PhotoImage(file=wallpaper_path)
...
if __name__ == '__main__':
	...
	wallpaper_folder = 'new'
	img = change_wallpaper(wallpaper_folder)
